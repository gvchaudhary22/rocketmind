---
description: RocketMind /rocketmind:eval - evaluate routing, workflow compliance, and portability
allowed-tools: all
---
...
- `.rocketmind/reports/eval/EVAL-REPORT.md` by default
- `.rocketmind/reports/eval/eval-report.json` by default
