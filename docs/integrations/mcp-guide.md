...
## Recommended MCPs for RocketMind Projects
...
- **When**: Shiprocket projects tracked in Linear

#### `sentry`
- **Purpose**: Read Sentry errors, stack traces, issue context
- **Install**: `npx @modelcontextprotocol/server-sentry`
- **Env**: `SENTRY_AUTH_TOKEN=...`, `SENTRY_ORG=shiprocket`
- **When**: Debugging production errors during `/rocketmind:debug`
