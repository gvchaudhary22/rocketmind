#!/usr/bin/env node
/**
 * bin/db.js — RocketMind shared database module
 *
...
const DB_PATH = path.join(__dirname, '..', '.rocketmind', 'context.db');

/**
 * Open (or create) the RocketMind SQLite database.
...
/**
 * Create all RocketMind tables if they don't exist (idempotent).
