#!/usr/bin/env node
/**
 * RocketMind Changelog Extractor
 *
 ...
 * in order (newest first) into docs/releases/release-notes.md. This covers the case where
...
const notesPath = path.join(process.cwd(), 'docs', 'releases', 'release-notes.md');
