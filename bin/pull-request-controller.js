...
function buildPullRequestBody({
  ...
  changedFiles = [],
  reviewCommand = '/rocketmind:review',
  ...
  const mergeNoteLines = mergeNotes.length
    ? mergeNotes
    : ['Auto-generated from `/rocketmind:quick` clean review state.'];
...
function syncPullRequest(
  ...
  const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'rocketmind-pr-body-'));
