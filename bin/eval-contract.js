...
const DEFAULT_OUTPUT_DIR = path.join(ROOT, '.rocketmind', 'reports', 'eval');
...
function main() {
  ...
  const docChecks = validateResult.pass
    ...
    : [
        {
          check: 'RocketMind validation passes before eval',
          pass: false,
          reason:
  ...
  process.stdout.write(`RocketMind eval artifact written to ${markdownReportPath}\n`);
