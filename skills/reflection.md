...
## ACTIVATION
- Task failure during `/rocketmind:build`.
- Test regressions in `/rocketmind:verify`.
...
2.  **Context preservation**: Before attempting a fix, dump the full stack trace and environmental state into `.rocketmind/state/last_error.json`.
...
## CHECKLISTS
- [ ] Error trace captured in `.rocketmind/state/`
