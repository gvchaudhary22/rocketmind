...
|---------|-------|-------|--------|
| Stripe Connect onboarding KYC takes 24h+ in sandbox | @team | 2026-03-20 | Open — using test accounts to unblock |
...
- [ ] Platform fee calculation (Shiprocket takes 12%)
