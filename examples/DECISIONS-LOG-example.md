# DECISIONS-LOG.md — Shiprocket Platform Example
...
- decision: "Use Stripe Connect for employer-to-worker payouts"
  ...
  rationale: "Shiprocket takes a platform fee and needs split payments. Stripe Connect supports this directly; Stripe Checkout alone does not."
  supersedes: []
  still_valid: true
  invalidated_at: ""
