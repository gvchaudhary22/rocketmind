...
describe('pull-request controller', () => {
  ...
  it('builds a governance-shaped PR body', () => {
    ...
    expect(body).toContain('## RocketMind Self-Review');
  });
  ...
  it('creates a PR when none exists for the branch', () => {
      ...
      },
      {
        ghRunner: (args) => {
          ...
          if (args[0] === 'pr' && args[1] === 'create')
            return 'https://github.com/shiprocket/rocketmind/pull/999';
    ...
    expect(result).toEqual({
      action: 'created',
      number: 999,
      url: 'https://github.com/shiprocket/rocketmind/pull/999',
    });
            ...
            return JSON.stringify([
              {
                number: 321,
                title: 'existing',
                url: 'https://github.com/shiprocket/rocketmind/pull/321',
              },
            ]);
          }
