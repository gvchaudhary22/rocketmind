...
describe('plan index generator', () => {
  ...
  it('renders active plans in rank order', () => {
    ...
    const enforcementIndex = rendered.indexOf('issue-130-rocketmind-enforcement-remediation.md');
    ...
    expect(rendered).toContain('[issue-130-rocketmind-enforcement-remediation.md](issue-130-rocketmind-enforcement-remediation.md)');
