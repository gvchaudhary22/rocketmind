#!/usr/bin/env bash
# RocketMind Stop Hook — Runs when Claude Code session ends (agent responds with final answer)
...
echo "RocketMind: Session recorded at $TIMESTAMP (branch=$GIT_BRANCH, commit=$GIT_COMMIT)" >&2
exit 0
